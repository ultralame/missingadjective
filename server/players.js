//players.js
//this module provides functions that allow players to join and leave rooms
...
module.exports.joinRoom = function(player, roomProperties) {
  ...
  //set the player radius
  player.radius = Defaults.PLAYER_RADIUS;

  //put the player in the correct starting location
  // player.position = PLAYER_DEFAULT_COORDINATES[player.team]; //old way that puts every player on same team in same position 
